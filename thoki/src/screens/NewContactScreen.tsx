...
export default function NewContactScreen() {
  ...
  return (
    <ImageBackground
      ...
      className=" flex-1 w-full h-full bg-cover bg-center items-center justify-center"
    >
      <SafeAreaView className="">

        <View className="bg-white/50 rounded-2xl m-5 pb-[30px] w-[350px] ">
          <Text className="text-3xl font-normal mt-[30px] ms-[30px] mb-[40px] text-purple-800">Create new contact</Text>
          <View className="lex-1 px-5">
            ...
            <View className="border-b-2 border-purple-800 justify-center items-center flex-row h-14 mt-8 ">
              <CountryPicker
            ...
            <View className="mt-10">
              <Pressable
                className="bg-purple-800 h-14 items-center justify-center rounded-2xl"
                onPress={() => {
